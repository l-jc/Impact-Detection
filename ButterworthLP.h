...
public:
    ...
    */
    ...
    void vecfilter(const std::vector<double> &input, std::vector<double> &output, const size_t size, const double initialConditionValue = 0.0, const bool forwardBackward = false);
